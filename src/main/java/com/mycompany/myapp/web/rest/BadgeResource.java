...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Badge}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BadgeResource {
     ...
     */
    @GetMapping("/badges")
    public ResponseEntity<List<Badge>> getAllBadges(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
