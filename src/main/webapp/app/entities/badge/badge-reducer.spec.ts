...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './badge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BADGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BADGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BADGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BADGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BADGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BADGE actions', async () => {
      const expectedActions = [
        {
