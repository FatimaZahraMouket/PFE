...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './offre.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OFFRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OFFRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OFFRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OFFRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OFFRE actions', async () => {
      const expectedActions = [
        {
