...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pays.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYS actions', async () => {
      const expectedActions = [
        {
