...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './planning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANNING_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANNING actions', async () => {
      const expectedActions = [
        {
