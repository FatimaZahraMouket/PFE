...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './programme.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAMME_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRAMME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRAMME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRAMME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAMME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRAMME actions', async () => {
      const expectedActions = [
        {
