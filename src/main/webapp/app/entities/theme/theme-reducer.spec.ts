...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './theme.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEME_LIST actions', async () => {
    ...
    it('dispatches FETCH_THEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THEME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THEME actions', async () => {
      const expectedActions = [
        {
